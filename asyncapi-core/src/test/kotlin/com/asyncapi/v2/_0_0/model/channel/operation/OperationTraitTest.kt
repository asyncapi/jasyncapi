...
class OperationTraitTest: SerDeTest<OperationTrait>() {
    ...
    override fun baseObjectJson() = "/json/2.0.0/model/channel/operation/operationTrait.json"

    override fun extendedObjectJson() = "/json/2.0.0/model/channel/operation/operationTrait - extended.json"

    override fun wronglyExtendedObjectJson() = "/json/2.0.0/model/channel/operation/operationTrait - wrongly extended.json"
