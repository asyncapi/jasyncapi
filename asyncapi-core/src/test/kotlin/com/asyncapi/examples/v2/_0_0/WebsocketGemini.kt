...
class WebsocketGemini: AbstractExampleValidationTest() {
    ...
    override fun specificationLocation(): String = "/examples/v2.0.0/websocket-gemini.yml"
                ...
                .messages(mapOf(
                        Pair(
                                ...
                                Message.builder()
                                        ...
                                        .examples(listOf(
                                                mapOf(
                                                        Pair("name", "updateMessage"),
                                                        Pair("summary", "Example of an update message that contains a change in price information."),
                                                        Pair("payload", mapOf(
                                                                Pair("type", "update"),
                                                ...
                                                mapOf(
                                                        Pair("name", "heartbeatMessage"),
                                                        Pair("summary", "Example of additional heartbeat message when you enable them."),
                                                        Pair("payload", mapOf(
                                                                Pair("type", "heartbeat"),
