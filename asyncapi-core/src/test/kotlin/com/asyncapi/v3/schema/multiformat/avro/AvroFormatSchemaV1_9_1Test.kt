...
abstract class AvroFormatSchemaV1_9_1Test: AvroFormatSchemaTest() {
        ...
        override fun provideArguments(context: ExtensionContext?): Stream<out Arguments> {
            return Stream.of(
                Arguments.of(
                    ...
                    AvroFormatSchema("application/vnd.apache.avro+json;version=1.9.1", AvroSchemasProvider().applicationEventTest())
                ),
                Arguments.of(
                    "/json/v3/schema/multiformat/avro/1.9.1/vnd.apache.avro+json/DocumentInfo.json",
                    AvroFormatSchema("application/vnd.apache.avro+json;version=1.9.1", AvroSchemasProvider().documentInfo())
                ),
                Arguments.of(
                    "/json/v3/schema/multiformat/avro/1.9.1/vnd.apache.avro+json/foo.Bar.json",
                    AvroFormatSchema("application/vnd.apache.avro+json;version=1.9.1", AvroSchemasProvider().fooBar())
                ),
                Arguments.of(
                    "/json/v3/schema/multiformat/avro/1.9.1/vnd.apache.avro+json/full_record_v1.json",
                    AvroFormatSchema("application/vnd.apache.avro+json;version=1.9.1", AvroSchemasProvider().fullRecordV1())
                ),
                Arguments.of(
                    "/json/v3/schema/multiformat/avro/1.9.1/vnd.apache.avro+json/full_record_v2.json",
                    AvroFormatSchema("application/vnd.apache.avro+json;version=1.9.1", AvroSchemasProvider().fullRecordV2())
                ),
                Arguments.of(
                    "/json/v3/schema/multiformat/avro/1.9.1/vnd.apache.avro+json/logical-uuid.json",
                    AvroFormatSchema("application/vnd.apache.avro+json;version=1.9.1", AvroSchemasProvider().logicalUUID())
                ),
                Arguments.of(
                    "/json/v3/schema/multiformat/avro/1.9.1/vnd.apache.avro+json/logical_types_with_multiple_fields.json",
                    AvroFormatSchema("application/vnd.apache.avro+json;version=1.9.1", AvroSchemasProvider().logicalTypesWithMultipleFields())
                ),
                Arguments.of(
                    "/json/v3/schema/multiformat/avro/1.9.1/vnd.apache.avro+json/MyResponse.json",
                    AvroFormatSchema("application/vnd.apache.avro+json;version=1.9.1", AvroSchemasProvider().myResponse())
                ),
                Arguments.of(
                    "/json/v3/schema/multiformat/avro/1.9.1/vnd.apache.avro+json/regression_error_field_in_record.json",
                    AvroFormatSchema("application/vnd.apache.avro+json;version=1.9.1", AvroSchemasProvider().regressionErrorFieldInRecord())
                ),
                Arguments.of(
                    "/json/v3/schema/multiformat/avro/1.9.1/vnd.apache.avro+json/schema-location.json",
                    AvroFormatSchema("application/vnd.apache.avro+json;version=1.9.1", AvroSchemasProvider().schemaLocation())
                ),
                Arguments.of(
                    "/json/v3/schema/multiformat/avro/1.9.1/vnd.apache.avro+json/schema-location-read.json",
                    AvroFormatSchema("application/vnd.apache.avro+json;version=1.9.1", AvroSchemasProvider().schemaLocationRead())
                ),
                Arguments.of(
                ...
                Arguments.of(
                    ...
                    AvroFormatSchema("application/vnd.apache.avro+json;version=1.9.1", AvroSchemasProvider().simpleRecord())
                ),
                Arguments.of(
                ...
                Arguments.of(
                    ...
                    AvroFormatSchema("application/vnd.apache.avro+json;version=1.9.1", AvroSchemasProvider().testUnionRecord())
                ),
                Arguments.of(
                    "/json/v3/schema/multiformat/avro/1.9.1/vnd.apache.avro+json/union_and_fixed_fields.json",
                    AvroFormatSchema("application/vnd.apache.avro+json;version=1.9.1", AvroSchemasProvider().unionAndFixedFields())
                ),

                Arguments.of(
                    "/json/v3/schema/multiformat/avro/1.9.1/vnd.apache.avro/ApplicationEvent.json",
                    AvroFormatSchema("application/vnd.apache.avro;version=1.9.1", AvroSchemasProvider().applicationEventTest())
                ),
                Arguments.of(
                    "/json/v3/schema/multiformat/avro/1.9.1/vnd.apache.avro/DocumentInfo.json",
                    AvroFormatSchema("application/vnd.apache.avro;version=1.9.1", AvroSchemasProvider().documentInfo())
                ),
                Arguments.of(
                    "/json/v3/schema/multiformat/avro/1.9.1/vnd.apache.avro/foo.Bar.json",
                    AvroFormatSchema("application/vnd.apache.avro;version=1.9.1", AvroSchemasProvider().fooBar())
                ),
                Arguments.of(
                    "/json/v3/schema/multiformat/avro/1.9.1/vnd.apache.avro/full_record_v1.json",
                    AvroFormatSchema("application/vnd.apache.avro;version=1.9.1", AvroSchemasProvider().fullRecordV1())
                ),
                Arguments.of(
                    "/json/v3/schema/multiformat/avro/1.9.1/vnd.apache.avro/full_record_v2.json",
                    AvroFormatSchema("application/vnd.apache.avro;version=1.9.1", AvroSchemasProvider().fullRecordV2())
                ),
                Arguments.of(
                    "/json/v3/schema/multiformat/avro/1.9.1/vnd.apache.avro/logical-uuid.json",
                    AvroFormatSchema("application/vnd.apache.avro;version=1.9.1", AvroSchemasProvider().logicalUUID())
                ),
                Arguments.of(
                    "/json/v3/schema/multiformat/avro/1.9.1/vnd.apache.avro/logical_types_with_multiple_fields.json",
                    AvroFormatSchema("application/vnd.apache.avro;version=1.9.1", AvroSchemasProvider().logicalTypesWithMultipleFields())
                ),
                Arguments.of(
                    "/json/v3/schema/multiformat/avro/1.9.1/vnd.apache.avro/MyResponse.json",
                    AvroFormatSchema("application/vnd.apache.avro;version=1.9.1", AvroSchemasProvider().myResponse())
                ),
                Arguments.of(
                    "/json/v3/schema/multiformat/avro/1.9.1/vnd.apache.avro/regression_error_field_in_record.json",
                    AvroFormatSchema("application/vnd.apache.avro;version=1.9.1", AvroSchemasProvider().regressionErrorFieldInRecord())
                ),
                Arguments.of(
                    "/json/v3/schema/multiformat/avro/1.9.1/vnd.apache.avro/schema-location.json",
                    AvroFormatSchema("application/vnd.apache.avro;version=1.9.1", AvroSchemasProvider().schemaLocation())
                ),
                Arguments.of(
                    "/json/v3/schema/multiformat/avro/1.9.1/vnd.apache.avro/schema-location-read.json",
                    AvroFormatSchema("application/vnd.apache.avro;version=1.9.1", AvroSchemasProvider().schemaLocationRead())
                ),
                Arguments.of(
                ...
                Arguments.of(
                    ...
                    AvroFormatSchema("application/vnd.apache.avro;version=1.9.1", AvroSchemasProvider().simpleRecord())
                ),
                Arguments.of(
                ...
                Arguments.of(
                    ...
                    AvroFormatSchema("application/vnd.apache.avro;version=1.9.1", AvroSchemasProvider().testUnionRecord())
                ),
                Arguments.of(
                    "/json/v3/schema/multiformat/avro/1.9.1/vnd.apache.avro/union_and_fixed_fields.json",
                    AvroFormatSchema("application/vnd.apache.avro;version=1.9.1", AvroSchemasProvider().unionAndFixedFields())
                ),
            )
        }
        ...
        override fun provideArguments(context: ExtensionContext?): Stream<out Arguments> {
            return Stream.of(
                Arguments.of(
                    ...
                    AvroFormatSchema("application/vnd.apache.avro+yaml;version=1.9.1", AvroSchemasProvider().applicationEventTest())
                ),
                Arguments.of(
                    "/json/v3/schema/multiformat/avro/1.9.1/vnd.apache.avro+yaml/DocumentInfo.yaml",
                    AvroFormatSchema("application/vnd.apache.avro+yaml;version=1.9.1", AvroSchemasProvider().documentInfo())
                ),
                Arguments.of(
                    "/json/v3/schema/multiformat/avro/1.9.1/vnd.apache.avro+yaml/foo.Bar.yaml",
                    AvroFormatSchema("application/vnd.apache.avro+yaml;version=1.9.1", AvroSchemasProvider().fooBar())
                ),
                Arguments.of(
                    "/json/v3/schema/multiformat/avro/1.9.1/vnd.apache.avro+yaml/full_record_v1.yaml",
                    AvroFormatSchema("application/vnd.apache.avro+yaml;version=1.9.1", AvroSchemasProvider().fullRecordV1())
                ),
                Arguments.of(
                    "/json/v3/schema/multiformat/avro/1.9.1/vnd.apache.avro+yaml/full_record_v2.yaml",
                    AvroFormatSchema("application/vnd.apache.avro+yaml;version=1.9.1", AvroSchemasProvider().fullRecordV2())
                ),
                Arguments.of(
                    "/json/v3/schema/multiformat/avro/1.9.1/vnd.apache.avro+yaml/logical-uuid.yaml",
                    AvroFormatSchema("application/vnd.apache.avro+yaml;version=1.9.1", AvroSchemasProvider().logicalUUID())
                ),
                Arguments.of(
                    "/json/v3/schema/multiformat/avro/1.9.1/vnd.apache.avro+yaml/logical_types_with_multiple_fields.yaml",
                    AvroFormatSchema("application/vnd.apache.avro+yaml;version=1.9.1", AvroSchemasProvider().logicalTypesWithMultipleFields())
                ),
                Arguments.of(
                    "/json/v3/schema/multiformat/avro/1.9.1/vnd.apache.avro+yaml/MyResponse.yaml",
                    AvroFormatSchema("application/vnd.apache.avro+yaml;version=1.9.1", AvroSchemasProvider().myResponse())
                ),
                Arguments.of(
                    "/json/v3/schema/multiformat/avro/1.9.1/vnd.apache.avro+yaml/regression_error_field_in_record.yaml",
                    AvroFormatSchema("application/vnd.apache.avro+yaml;version=1.9.1", AvroSchemasProvider().regressionErrorFieldInRecord())
                ),
                Arguments.of(
                    "/json/v3/schema/multiformat/avro/1.9.1/vnd.apache.avro+yaml/schema-location.yaml",
                    AvroFormatSchema("application/vnd.apache.avro+yaml;version=1.9.1", AvroSchemasProvider().schemaLocation())
                ),
                Arguments.of(
                    "/json/v3/schema/multiformat/avro/1.9.1/vnd.apache.avro+yaml/schema-location-read.yaml",
                    AvroFormatSchema("application/vnd.apache.avro+yaml;version=1.9.1", AvroSchemasProvider().schemaLocationRead())
                ),
                Arguments.of(
                ...
                Arguments.of(
                    ...
                    AvroFormatSchema("application/vnd.apache.avro+yaml;version=1.9.1", AvroSchemasProvider().simpleRecord())
                ),
                Arguments.of(
                ...
                Arguments.of(
                    ...
                    AvroFormatSchema("application/vnd.apache.avro+yaml;version=1.9.1", AvroSchemasProvider().testUnionRecord())
                ),
                Arguments.of(
                    "/json/v3/schema/multiformat/avro/1.9.1/vnd.apache.avro+yaml/union_and_fixed_fields.yaml",
                    AvroFormatSchema("application/vnd.apache.avro+yaml;version=1.9.1", AvroSchemasProvider().unionAndFixedFields())
                ),
