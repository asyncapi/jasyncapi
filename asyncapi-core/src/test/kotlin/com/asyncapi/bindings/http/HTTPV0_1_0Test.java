...
public class HTTPV0_1_0Test {
    ...
    class ChannelTest extends BindingTest<HTTPChannelBinding> {{
        ...
        super.pathToBindingJson                = "/bindings/http/0.1.0/channel/binding.json";
        super.pathToExtendedBindingJson        = "/bindings/http/0.1.0/channel/binding - extended.json";
        super.pathToWronglyExtendedBindingJson = "/bindings/http/0.1.0/channel/binding - wrongly extended.json";
    }}
    ...
    class Message extends BindingTest<HTTPMessageBinding> {{
        ...
        super.pathToBindingJson                = "/bindings/http/0.1.0/message/binding.json";
        super.pathToExtendedBindingJson        = "/bindings/http/0.1.0/message/binding - extended.json";
        super.pathToWronglyExtendedBindingJson = "/bindings/http/0.1.0/message/binding - wrongly extended.json";
    }}
    ...
    class Operation extends BindingTest<HTTPOperationBinding> {{
        ...
        super.pathToBindingJson                = "/bindings/http/0.1.0/operation/binding.json";
        super.pathToExtendedBindingJson        = "/bindings/http/0.1.0/operation/binding - extended.json";
        super.pathToWronglyExtendedBindingJson = "/bindings/http/0.1.0/operation/binding - wrongly extended.json";
    }}
    ...
    class Server extends BindingTest<HTTPServerBinding> {{
        ...
        super.pathToBindingJson                = "/bindings/http/0.1.0/server/binding.json";
        super.pathToExtendedBindingJson        = "/bindings/http/0.1.0/server/binding - extended.json";
        super.pathToWronglyExtendedBindingJson = "/bindings/http/0.1.0/server/binding - wrongly extended.json";
    }}
