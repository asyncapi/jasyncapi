package com.asyncapi.bindings.redis.withoutversion.operation;
...
public abstract class RedisOperationBindingTest extends SerDeTest<RedisOperationBinding> {
    ...
    protected String baseObjectJson() {
        return "/bindings/default implementation/without version/operation/binding.json";
    }

    @NotNull
    @Override
    protected String extendedObjectJson() {
        return "/bindings/default implementation/without version/operation/binding - extended.json";
    }

    @NotNull
    @Override
    protected String wronglyExtendedObjectJson() {
        return "/bindings/default implementation/without version/operation/binding - wrongly extended.json";
    }
