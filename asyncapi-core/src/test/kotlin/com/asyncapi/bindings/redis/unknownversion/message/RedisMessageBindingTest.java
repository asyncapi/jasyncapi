package com.asyncapi.bindings.redis.unknownversion.message;
...
public abstract class RedisMessageBindingTest extends SerDeTest<RedisMessageBinding> {
    ...
    protected String baseObjectJson() {
        return "/bindings/default implementation/unknown version/message/binding.json";
    }

    @NotNull
    @Override
    protected String extendedObjectJson() {
        return "/bindings/default implementation/unknown version/message/binding - extended.json";
    }

    @NotNull
    @Override
    protected String wronglyExtendedObjectJson() {
        return "/bindings/default implementation/unknown version/message/binding - wrongly extended.json";
    }
