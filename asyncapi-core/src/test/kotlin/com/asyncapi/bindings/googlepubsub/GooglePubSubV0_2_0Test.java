...
import com.asyncapi.bindings.googlepubsub.v0._2_0.channel.GooglePubSubChannelMessageStoragePolicy;
import com.asyncapi.bindings.googlepubsub.v0._2_0.channel.GooglePubSubChannelSchemaSettings;
...
@DisplayName("0.2.0")
public class GooglePubSubV0_2_0Test {
    ...
    class ChannelTest extends BindingTest<GooglePubSubChannelBinding> {{
        ...
        super.pathToBindingJson                = "/bindings/googlepubsub/0.2.0/channel/binding.json";
        super.pathToExtendedBindingJson        = "/bindings/googlepubsub/0.2.0/channel/binding - extended.json";
        super.pathToWronglyExtendedBindingJson = "/bindings/googlepubsub/0.2.0/channel/binding - wrongly extended.json";
    }}
    ...
    class Message extends BindingTest<GooglePubSubMessageBinding> {{
        ...
        super.pathToBindingJson                = "/bindings/googlepubsub/0.2.0/message/binding.json";
        super.pathToExtendedBindingJson        = "/bindings/googlepubsub/0.2.0/message/binding - extended.json";
        super.pathToWronglyExtendedBindingJson = "/bindings/googlepubsub/0.2.0/message/binding - wrongly extended.json";
    }}
    ...
    class Operation extends BindingTest<GooglePubSubOperationBinding> {{
        ...
        super.pathToBindingJson                = "/bindings/googlepubsub/0.2.0/operation/binding.json";
        super.pathToExtendedBindingJson        = "/bindings/googlepubsub/0.2.0/operation/binding - extended.json";
        super.pathToWronglyExtendedBindingJson = "/bindings/googlepubsub/0.2.0/operation/binding - wrongly extended.json";
    }}
    ...
    class Server extends BindingTest<GooglePubSubServerBinding> {{
        ...
        super.pathToBindingJson                = "/bindings/googlepubsub/0.2.0/server/binding.json";
        super.pathToExtendedBindingJson        = "/bindings/googlepubsub/0.2.0/server/binding - extended.json";
        super.pathToWronglyExtendedBindingJson = "/bindings/googlepubsub/0.2.0/server/binding - wrongly extended.json";
    }}
