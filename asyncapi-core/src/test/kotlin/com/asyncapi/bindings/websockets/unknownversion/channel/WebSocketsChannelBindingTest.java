package com.asyncapi.bindings.websockets.unknownversion.channel;
...
public abstract class WebSocketsChannelBindingTest extends SerDeTest<WebSocketsChannelBinding> {
    ...
    protected String baseObjectJson() {
        return "/bindings/websockets/unknown version/channel/webSocketsChannelBinding.json";
    }

    @NotNull
    @Override
    protected String extendedObjectJson() {
        return "/bindings/websockets/unknown version/channel/webSocketsChannelBinding - extended.json";
    }

    @NotNull
    @Override
    protected String wronglyExtendedObjectJson() {
        return "/bindings/websockets/unknown version/channel/webSocketsChannelBinding - wrongly extended.json";
    }
