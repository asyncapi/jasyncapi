package com.asyncapi.bindings.websockets.latest.channel;
...
public abstract  class WebSocketsChannelBindingTest extends SerDeTest<WebSocketsChannelBinding> {
    ...
    protected String baseObjectJson() {
        return "/bindings/websockets/latest/channel/webSocketsChannelBinding.json";
    }

    @NotNull
    @Override
    protected String extendedObjectJson() {
        return "/bindings/websockets/latest/channel/webSocketsChannelBinding - extended.json";
    }

    @NotNull
    @Override
    protected String wronglyExtendedObjectJson() {
        return "/bindings/websockets/latest/channel/webSocketsChannelBinding - wrongly extended.json";
    }
