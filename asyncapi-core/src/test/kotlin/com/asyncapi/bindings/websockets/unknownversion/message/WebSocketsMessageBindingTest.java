package com.asyncapi.bindings.websockets.unknownversion.message;
...
public abstract class WebSocketsMessageBindingTest extends SerDeTest<WebSocketsMessageBinding> {
    ...
    protected String baseObjectJson() {
        return "/bindings/websockets/unknown version/message/webSocketsMessageBinding.json";
    }

    @NotNull
    @Override
    protected String extendedObjectJson() {
        return "/bindings/websockets/unknown version/message/webSocketsMessageBinding - extended.json";
    }

    @NotNull
    @Override
    protected String wronglyExtendedObjectJson() {
        return "/bindings/websockets/unknown version/message/webSocketsMessageBinding - wrongly extended.json";
    }
