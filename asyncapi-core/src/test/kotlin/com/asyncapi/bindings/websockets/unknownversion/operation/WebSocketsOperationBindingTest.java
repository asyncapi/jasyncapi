package com.asyncapi.bindings.websockets.unknownversion.operation;
...
public abstract class WebSocketsOperationBindingTest extends SerDeTest<WebSocketsOperationBinding> {
    ...
    protected String baseObjectJson() {
        return "/bindings/websockets/unknown version/operation/webSocketsOperationBinding.json";
    }

    @NotNull
    @Override
    protected String extendedObjectJson() {
        return "/bindings/websockets/unknown version/operation/webSocketsOperationBinding - extended.json";
    }

    @NotNull
    @Override
    protected String wronglyExtendedObjectJson() {
        return "/bindings/websockets/unknown version/operation/webSocketsOperationBinding - wrongly extended.json";
    }
