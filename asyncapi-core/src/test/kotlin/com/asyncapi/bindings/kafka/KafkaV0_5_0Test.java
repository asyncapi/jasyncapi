...
import com.asyncapi.bindings.kafka.v0._5_0.message.KafkaMessageSchemaIdLocation;
...
public class KafkaV0_5_0Test {
    ...
    class ChannelTest extends BindingTest<KafkaChannelBinding> {{
        ...
        super.pathToBindingJson                = "/bindings/kafka/0.5.0/channel/binding.json";
        super.pathToExtendedBindingJson        = "/bindings/kafka/0.5.0/channel/binding - extended.json";
        super.pathToWronglyExtendedBindingJson = "/bindings/kafka/0.5.0/channel/binding - wrongly extended.json";
    }}
    ...
    class Message extends BindingTest<KafkaMessageBinding> {{
        ...
        super.pathToBindingJson                = "/bindings/kafka/0.5.0/message/binding.json";
        super.pathToExtendedBindingJson        = "/bindings/kafka/0.5.0/message/binding - extended.json";
        super.pathToWronglyExtendedBindingJson = "/bindings/kafka/0.5.0/message/binding - wrongly extended.json";
    }}
    ...
    class Operation extends BindingTest<KafkaOperationBinding> {{
        ...
        super.pathToBindingJson                = "/bindings/kafka/0.5.0/operation/binding.json";
        super.pathToExtendedBindingJson        = "/bindings/kafka/0.5.0/operation/binding - extended.json";
        super.pathToWronglyExtendedBindingJson = "/bindings/kafka/0.5.0/operation/binding - wrongly extended.json";
    }}
    ...
    class Server extends BindingTest<KafkaServerBinding> {{
        ...
        super.pathToBindingJson                = "/bindings/kafka/0.5.0/server/binding.json";
        super.pathToExtendedBindingJson        = "/bindings/kafka/0.5.0/server/binding - extended.json";
        super.pathToWronglyExtendedBindingJson = "/bindings/kafka/0.5.0/server/binding - wrongly extended.json";
    }}
