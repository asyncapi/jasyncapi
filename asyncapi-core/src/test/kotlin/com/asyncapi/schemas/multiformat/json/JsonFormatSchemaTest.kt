package com.asyncapi.schemas.multiformat.json
...
abstract class JsonFormatSchemaTest {
    ...
    @ArgumentsSource(com.asyncapi.schemas.multiformat.json.JsonFormatSchemaTest.Json::class)
    ...
    @ArgumentsSource(com.asyncapi.schemas.multiformat.json.JsonFormatSchemaTest.Yaml::class)
    @ParameterizedTest(name = "Read: {0}")
    fun parseYaml(
        jsonFormatSchemaToCompareWithFilePath: String,
        jsonFormatSchema: JsonFormatSchema
