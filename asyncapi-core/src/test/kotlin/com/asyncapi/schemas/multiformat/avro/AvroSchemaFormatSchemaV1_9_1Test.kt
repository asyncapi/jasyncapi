...
abstract class AvroFormatSchemaV1_9_1Test: com.asyncapi.schemas.multiformat.avro.AvroFormatSchemaTest() {

    @ArgumentsSource(com.asyncapi.schemas.multiformat.avro.AvroFormatSchemaV1_9_1Test.JsonFormat::class)
    ...
    @ArgumentsSource(com.asyncapi.schemas.multiformat.avro.AvroFormatSchemaV1_9_1Test.YamlFormat::class)
    @ParameterizedTest(name = "Read: {0}")
