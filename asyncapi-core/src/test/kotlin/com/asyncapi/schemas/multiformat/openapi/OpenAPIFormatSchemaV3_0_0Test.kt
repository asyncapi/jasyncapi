...
abstract class OpenAPIFormatSchemaV3_0_0Test: OpenAPIFormatSchemaTest() {
    ...
    class JsonFormat: ArgumentsProvider {
        ...
        override fun provideArguments(context: ExtensionContext?): Stream<out Arguments> {
            return Stream.of(
                Arguments.of("/schemas/multiformat/openapi/3.0.0/vnd.oai.openapi/schema.json",
                    OpenAPIFormatSchema(
                        "application/vnd.oai.openapi;version=3.0.0",
                        SchemaTest().openAPISchema()
                    )
                ),
                Arguments.of("/schemas/multiformat/openapi/3.0.0/vnd.oai.openapi+json/schema.json",
                    OpenAPIFormatSchema(
    ...
    class YamlFormat: ArgumentsProvider {
        ...
        override fun provideArguments(context: ExtensionContext?): Stream<out Arguments> {
            return Stream.of(
                Arguments.of("/schemas/multiformat/openapi/3.0.0/vnd.oai.openapi/schema.yaml",
                    OpenAPIFormatSchema(
                        "application/vnd.oai.openapi;version=3.0.0",
                        SchemaTest().openAPISchema()
                    )
                ),
                Arguments.of("/schemas/multiformat/openapi/3.0.0/vnd.oai.openapi+yaml/schema.yaml",
                    OpenAPIFormatSchema(
