...
class ImplicitOAuthFlowTest: SerDeTest<ImplicitOAuthFlow>() {
    ...
    override fun baseObjectJson() = "/schemas/security/v3/oauth2/flow/implicitOAuthFlow.json"

    override fun extendedObjectJson() = "/schemas/security/v3/oauth2/flow/implicitOAuthFlow - extended.json"

    override fun wronglyExtendedObjectJson() = "/schemas/security/v3/oauth2/flow/implicitOAuthFlow - wrongly extended.json"
