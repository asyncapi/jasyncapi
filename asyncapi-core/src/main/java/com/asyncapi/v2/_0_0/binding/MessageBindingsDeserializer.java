...
import com.asyncapi.v2._0_0.binding.amqp.AMQPMessageBinding;
import com.asyncapi.v2._0_0.binding.amqp1.AMQP1MessageBinding;
import com.asyncapi.v2._0_0.binding.http.HTTPMessageBinding;
import com.asyncapi.v2._0_0.binding.jms.JMSMessageBinding;
import com.asyncapi.v2._0_0.binding.kafka.KafkaMessageBinding;
import com.asyncapi.v2._0_0.binding.mqtt.MQTTMessageBinding;
import com.asyncapi.v2._0_0.binding.mqtt5.MQTT5MessageBinding;
import com.asyncapi.v2._0_0.binding.nats.NATSMessageBinding;
import com.asyncapi.v2._0_0.binding.redis.RedisMessageBinding;
import com.asyncapi.v2._0_0.binding.sns.SNSMessageBinding;
import com.asyncapi.v2._0_0.binding.solace.SolaceMessageBinding;
import com.asyncapi.v2._0_0.binding.sqs.SQSMessageBinding;
import com.asyncapi.v2._0_0.binding.stomp.STOMPMessageBinding;
import com.asyncapi.v2._0_0.binding.ws.WebSocketsMessageBinding;
