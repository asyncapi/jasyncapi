 ...
 */
public class ServerVariablesDeserializer extends JsonDeserializer<Map<String, Object>> {
    ...
    private Object chooseKnownPojo(JsonNode parametersValue) throws IOException {
        if (parametersValue.get("$ref") != null) {
            ...
            return objectMapper.readValue(parametersValue.toString(), ServerVariable.class);
        }
    }
