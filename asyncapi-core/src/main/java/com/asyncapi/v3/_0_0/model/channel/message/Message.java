...
public class Message extends ExtendableObject {
     ...
     * <p>
     * If this is a {@link AsyncAPISchema}, then the schemaFormat will be assumed to be
    ...
    @TextDocumentCompletion(
            detail = "AsyncAPISchema | MultiFormatSchema | Reference",
            documentation = "Definition of the message payload\n\n" +
                    "If this is an AsyncAPISchema, then the schemaFormat will be assumed to be application/vnd.aai.asyncapi+json;version=asyncapi.",
            variants = {AsyncAPISchema.class, MultiFormatSchema.class, Reference.class}
    )
    ...
    @TextDocumentCompletion(
            detail = "List<MessageTrait | Reference>",
            documentation = "Traits to apply to the message\n\n" +
                    "A list of traits to apply to the message object. Traits MUST be merged using traits merge mechanism. The resulting object MUST be a valid Message.",
